...
def write_SHANVIKA_inside_circle(text_color, x, y):
    my_turtle_cursor.penup()
    # Changing color of our cursor
    my_turtle_cursor.color(text_color)
    ...
    my_turtle_cursor.write("SHANVIKA", font=("sans-serif", 26, "bold"))
...
write_happy_inside_circle("#000000", -50, y_coordinate + 260)

# Writing "Birthday" inside of our circle
write_birthday_inside_circle("#000000", -70, y_coordinate + 210)

# Writing "SHANVIKA" inside of our circle
write_SHANVIKA_inside_circle("#000000", -90, y_coordinate + 170)
